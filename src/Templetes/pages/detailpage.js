    ...
    <div>
      {
        Api && Api.map(newapi=>(
           ...
           <section className="mb-5 mt-5" onLoad={onload}>
  
    <div className="row row-cols-md-2 bg p-0">
            <div className="col-md-6 col-12 mb-0 mt-2 rounded p-0">
              ...
              <div className="row row-cols-md-4 bg mt-2">
                <div className="col">
                  <div className="card shadow me-1 ms-1 mt1 mb-2 rounded text-center" style={{maxWidth:"4cm"}}>
                    <img src={newapi.image} className="card-img-top" onClick={click1} alt={newapi.name} style={{ maxWidth:"4cm"}} />
                  </div>
                </div>
                <div className="col">
                  <div className="card shadow me-1 ms-1 mt1 mb-2 text-center rounded" style={{maxWidth:"4cm"}}>
                    <img src={newapi.extraimage1} className="card-img-top" onClick={click2} alt={newapi.name} style={{ maxWidth:"4cm"}}/>
                  </div>
                </div>
                <div className="col">
                  <div className="card shadow me-1 ms-1 mt1 mb-2 text-center rounded" style={{maxWidth:"4cm"}}>
                    <img src={newapi.extraimage2} id='t' className="card-img-top" onClick={click3} alt={newapi.name} style={{ maxWidth:"4cm"}}/>
                  </div>
                </div>
                <div className="col">
                  <div className="card shadow me-1 ms-1 mt1 mb-2 text-center rounded" style={{maxWidth:"4cm"}}>
                    <img src={newapi.extraimage3} className="card-img-top" onClick={click4} alt={newapi.name} style={{ maxWidth:"4cm"}}/>
                  </div>
                </div>
              </div>
              </div>
