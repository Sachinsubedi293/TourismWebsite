...
const Header = ()=>{    
    return(
<header  data-aos-delay="100ms" >
      <Navbar className="navbar bg-dark" expand="lg"  role="navigation" style={{height:"70px"}} >
      <div className="container-fluid text-center" >
          <Link className="navbar-brand" to={"/"} > <img src={Logo} alt="logo"  height="48px"/></Link>
          <Navbar.Toggle  aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
          <ul className="navbar-nav mx-auto text-center" >
                <Link className="nav-link active rounded text-light c1 c2"to={"/"}><i className="fa fa-home" aria-hidden="true"></i> Home</Link>
